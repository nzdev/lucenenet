...
{
    /// <summary>
    /// Collector manager based on <see cref="TotalHitCountCollector"/> that allows users to parallelize
    /// counting the number of hits, expected to be used mostly wrapped in <see cref="MultiCollectorManager"/>.
