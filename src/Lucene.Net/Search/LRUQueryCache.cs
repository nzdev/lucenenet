 ...
 * @lucene.experimental
 */
public class LRUQueryCache : IQueryCache, Accountable {

  private readonly int maxSize;
private readonly long maxRamBytesUsed;
private readonly Predicate<LeafReaderContext> leavesToCache;
...
private readonly Map<Query, Query> uniqueQueries;
...
private readonly Set<Query> mostRecentlyUsedQueries;
private readonly Map<IndexReader.CacheKey, LeafCache> cache;
private readonly ReentrantLock lock;
private readonly float skipCacheFactor;
