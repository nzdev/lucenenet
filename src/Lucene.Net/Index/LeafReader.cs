...
instances are completely thread safe, meaning multiple
  ...
  */
    ///<summary>
    public abstract class LeafReader : IndexReader
    {

        private readonly LeafReaderContext readerContext = new LeafReaderContext(this);

        /** Sole constructor. (For invocation by subclass constructors, typically implicit.) */
        protected LeafReader() : base()
        {
        }

        public override sealed LeafReaderContext GetContext()
        {
            EnsureOpen();
